...
public class snakeWin extends JPanel implements ActionListener,KeyListener,Runnable{
	...
	JLabel label = new JLabel("your score is "+fenShu+"‚ also you died!");
	...
	public void paintComponent(Graphics g){
		...
		g.drawString("score"+fenShu, 170, 15);
		g.drawString("other"+Speed, 170, 35);
	...
	public void move(int x,int y){
		if (minYes(x, y)) {
			...
			nThread = null;
			label.setText("your score is "+fenShu+"‚ also you died!");
